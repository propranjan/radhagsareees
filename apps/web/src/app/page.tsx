...
import { ShoppingBag, Heart, User, Search, Menu, Phone, Mail, MapPin, RotateCcw, Shield, Clock, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="bg-gradient-to-r from-primary-50 to-secondary-50 rounded-2xl p-8 lg:p-10">
            <div className="max-w-4xl mx-auto">
              <h3 className="text-2xl font-serif font-bold text-gray-900 mb-6">Return Policy Guidelines</h3>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start gap-2">
                      ...
                      Unused items with original tags attached
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-500 mt-1">✓</span>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <div className="grid sm:grid-cols-3 gap-4 text-center">
                  <div className="bg-white rounded-lg p-4">
                    ...
                    <p className="text-sm text-gray-600">Initiate return request within 7 days of delivery</p>
                  </div>
                  <div className="bg-white rounded-lg p-4">
                    ...
                    <p className="text-sm text-gray-600">Schedule pickup or drop at nearest courier</p>
                  </div>
                  <div className="bg-white rounded-lg p-4">
                    ...
                    <p className="text-sm text-gray-600">Refund credited within 5-7 business days</p>
                  </div>
                </div>
                <p className="text-sm text-gray-500 mt-4 text-center">
                  All refunds are processed securely through Razorpay to your original payment method.
                </p>
              </div>
            </div>
          </div>
